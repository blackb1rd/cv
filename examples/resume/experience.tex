...
%---------------------------------------------------------
  \cventry
    ...
    {CP AXTRA Public Company Limited} % Organization
    {Bangkok, Thailand} % Location
    {July 2025 - Present} % Date(s)
    {Skill: C/C++ · C\#} % Skill
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
      \item {Developed and maintained software solutions for the company's internal systems, focusing on performance optimization and scalability.}
      \end{cvitems}
    }
