...
%---------------------------------------------------------
  \cventry
    ...
    {Skill: CMake · C++ · Qt · Linux · OpenCV · Git · Jira · Python (Programming Language) · Github action · Continuous Integration and Continuous Delivery (CI/CD) · vcpkg · OpenCL · KiCAD · Printed Circuit Board (PCB) Design · Docker · Go (Programming Language) · Angular · OpenCL Programming} % Skill
    {
      ...
      \item {Designed and developed a Manufacturing Execution System (MES) from scratch using Angular for a responsive frontend, GoLang for a high-performance backend, MySQL for robust data management, and Cypress for comprehensive end-to-end testing.}
